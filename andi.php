...
<html lang="en">
  <head>
    ...
    <title>Andi - Cyduks E-Sports</title>
          ...
          <div class="col-sm-9 col-9 text-right">
            ...
            <nav class="templateux-menu js-templateux-menu" role="navigation">
              <ul class="list-unstyled">
                <li class="active"><a href="andi" class="animsition-link"><b style="color: #dc3545;">Andi Agustiadi</b></a></li>
          ...
          <div class="col-md-10">
            <div class="row work-detail">
              <div class="col-md-4">
                ...
                <strong>CYD•Gado-Gado</strong>
              </div>
              <div class="col-md-4">
                <span class=caption>Role</span>
                <strong>Mage & Marksman</strong>
              </div>
              <div class="col-md-4">
                <span class=caption>Birth of Date</span>
                <strong>Jombang, 27 Agustus 1999</strong>
              </div>
            </div>
            


            <p class="text-center mb-5"><img src="images/team/andi.jpg" alt="Image placeholder" class="img-fluid"></p>
            ...
            <p class="text-center"><a href="http://instagram.com/andi_agstdi" class="button button--red">Follow me</a></p>
          </div>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-10">
            ...
            <p class="author">&mdash; <span>Andi Agustiadi</span></p>
          </div>
        </div>
      </div>
    </section>
