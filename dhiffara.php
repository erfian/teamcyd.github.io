...
<html lang="en">
  <head>
    ...
    <title>Dhiffara - Cyduks E-Sports</title>
          ...
          <div class="col-sm-9 col-9 text-right">
            ...
            <nav class="templateux-menu js-templateux-menu" role="navigation">
              <ul class="list-unstyled">
                <li class="active"><a href="dhiffara" class="animsition-link"><b style="color: #dc3545;">Dhiffara Rizqia</b></a></li>
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center intro">
          <div class="col-md-10" data-aos="fade-up">
            <h1>Dhiffara Rizqia Az-Zahra</h1>
          ...
          <div class="col-md-10">
            <div class="row work-detail">
              ...
              <div class="col-md-4">
                ...
                <strong>Mojokerto, 20 September 2000</strong>
              </div>
            </div>
            

            <p class="text-center mb-5"><img src="images/team/dhiffara.jpg" alt="Image placeholder" class="img-fluid"></p>
            ...
            <p class="text-center"><a href="http://instagram.com/dhiffara" class="button button--red">Follow me</a></p>
          </div>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-10">
            ...
            <p class="author">&mdash; <span>Dhiffara Rizqia Az-Zahra</span></p>
          </div>
        </div>
      </div>
    </section>
