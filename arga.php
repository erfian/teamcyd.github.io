...
<html lang="en">
  <head>
    ...
    <title>Arga - Cyduks E-Sports</title>
          ...
          <div class="col-sm-9 col-9 text-right">
            ...
            <nav class="templateux-menu js-templateux-menu" role="navigation">
              <ul class="list-unstyled">
                <li class="active"><a href="arga" class="animsition-link"><b style="color: #dc3545;">Muhammad Arga Pradipta</b></a></li>
          ...
          <div class="col-md-10">
            <div class="row work-detail">
              ...
              <div class="col-md-4">
                ...
                <strong>Jombang, 9 Desember 1999</strong>
              </div>
            </div>
            


            <p class="text-center mb-5"><img src="images/team/arga.jpg" alt="Image placeholder" class="img-fluid"></p>
            ...
            <p class="text-center"><a href="http://instagram.com/m.argap" class="button button--red">Follow me</a></p>
          </div>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-10">
            ...
            <p class="author">&mdash; <span>Muhammad Arga Pradipta</span></p>
          </div>
        </div>
      </div>
    </section>
