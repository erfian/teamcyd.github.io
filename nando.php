...
<html lang="en">
  <head>
    ...
    <title>Nando - Cyduks E-Sports</title>
          ...
          <div class="col-sm-9 col-9 text-right">
            ...
            <nav class="templateux-menu js-templateux-menu" role="navigation">
              <ul class="list-unstyled">
                <li class="active"><a href="nando" class="animsition-link"><b style="color: #dc3545;">Adinda Firnando</b></a></li>
          ...
          <div class="col-md-10">
            <div class="row work-detail">
              <div class="col-md-4">
                ...
                <strong>CYD•Ndo</strong>
              </div>
              <div class="col-md-4">
                <span class=caption>Role</span>
                <strong>Fighter & Mage</strong>
              </div>
              <div class="col-md-4">
                <span class=caption>Birth of Date</span>
                <strong>Jombang, 3 Desember 1999</strong>
              </div>
            </div>
            


            <p class="text-center mb-5"><img src="images/team/nando.jpg" alt="Image placeholder" class="img-fluid"></p>
            ...
            <p class="text-center"><a href="http://instagram.com/adi_firnando_" class="button button--red">Follow me</a></p>
          </div>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-10">
            ...
            <p class="author">&mdash; <span>Adinda Firnando</span></p>
          </div>
        </div>
      </div>
    </section>
