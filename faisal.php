...
<html lang="en">
  <head>
    ...
    <title>Faisal - Cyduks E-Sports</title>
          ...
          <div class="col-sm-9 col-9 text-right">
            ...
            <nav class="templateux-menu js-templateux-menu" role="navigation">
              <ul class="list-unstyled">
                <li class="active"><a href="faisal" class="animsition-link"><b style="color: #dc3545;">Faisal Hisyam Sani</b></a></li>
          ...
          <div class="col-md-10">
            <div class="row work-detail">
              ...
              <div class="col-md-4">
                ...
                <strong>Jombang, 22 Desember 1999</strong>
              </div>
            </div>
            

            <p class="text-center mb-5"><img src="images/team/faisal.jpg" alt="Image placeholder" class="img-fluid"></p>
            ...
            <p class="text-center"><a href="http://instagram.com/icallsani" class="button button--red">Follow me</a></p>
          </div>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-10">
            ...
            <p class="author">&mdash; <span>Faisal Hisyam Sani</span></p>
          </div>
        </div>
      </div>
    </section>
