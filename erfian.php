...
<html lang="en">
  <head>
    ...
    <title>Erfian - Cyduks E-Sports</title>
          ...
          <div class="col-sm-9 col-9 text-right">
            ...
            <nav class="templateux-menu js-templateux-menu" role="navigation">
              <ul class="list-unstyled">
                <li class="active"><a href="erfian" class="animsition-link"><b style="color: #dc3545;">Erfian Juliansyah</b></a></li>
                ...
                <li><a href="play" class="animsition-link"><b style="color: #dc3545;">Play With Us</b></a></li>
              </ul>
            </nav>  
          </div>
        </div>
          ...
          <div class="col-md-10">
            <div class="row work-detail">
              <div class="col-md-4">
                ...
                <strong>CYD•Xccurate</strong>
              </div>
              <div class="col-md-4">
                <span class=caption>Role</span>
                <strong>Assasin & Marksman</strong>
              </div>
              <div class="col-md-4">
                <span class=caption>Birth of Date</span>
                <strong>Jombang, 8 July 2000</strong>
              </div>
            </div>


            <p class="text-center mb-5"><img src="images/team/erfian.jpg" alt="Image placeholder" class="img-fluid"></p>
            ...
            <p class="text-center"><a href="http://instagram.com/erfianj" class="button button--red">Follow me</a></p>
          </div>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-10">
            ...
            <p class="author">&mdash; <span>Erfian Juliansyah</span></p>
          </div>
        </div>
      </div>
    </section>
