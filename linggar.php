...
<html lang="en">
  <head>
    ...
    <title>Linggar - Cyduks E-Sports</title>
          ...
          <div class="col-sm-9 col-9 text-right">
            ...
            <nav class="templateux-menu js-templateux-menu" role="navigation">
              <ul class="list-unstyled">
                <li class="active"><a href="linggar" class="animsition-link"><b style="color: #dc3545;">Linggar Yogi</b></a></li>
          ...
          <div class="col-md-10">
            <div class="row work-detail">
              <div class="col-md-4">
                ...
                <strong>Silent Reader</strong>
              </div>
              <div class="col-md-4">
                <span class=caption>Birth of Date</span>
                <strong>Jombang, 15 September 1999</strong>
              </div>
            </div>


            <p class="text-center mb-5"><img src="images/team/linggar.jpg" alt="Image placeholder" class="img-fluid"></p>
            ...
            <p class="text-center"><a href="http://instagram.com/linggar_yogi_ams" class="button button--red">Follow me</a></p>
          </div>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-10">
            ...
            <p class="author">&mdash; <span>Linggar Yogi</span></p>
          </div>
        </div>
      </div>
    </section>
